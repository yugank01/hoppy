...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center pt-6 pb-16 min-h-screen w-full gap-10">
      ...
      <div className="w-full flex flex-col gap-6 justify-center items-center">
        ...
        <div className="w-full flex flex-col gap-6 justify-center items-center bg-[#63681e] rounded-xl overflow-hidden shadow-xl p-3 mb-10">
          <Image width={2000} height={2000} src="/lore.PNG" className="rounded-xl" alt="Meet Hoppy" />
        </div>
      </div>

      <div className="w-full flex flex-col gap-6 justify-center items-center bg-[#63681e] rounded-xl overflow-hidden shadow-xl p-3">
