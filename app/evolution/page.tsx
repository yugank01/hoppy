        ...
        <div className='flex items-center justify-center w-full my-16'>
            <div className='flex justify-center flex-col gap-10 w-[95%]'>
                ...
                <div className='flex flex-col w-full justify-center items-center gap-8'>
                    <div className="w-[80%] mt-8 p-5 bg-[#63681e] rounded-2xl gap-8 flex flex-col">
                        ...
                        <div className='flex justify-center items-center'>
                            <Image width={300} height={600} src="/memetic-pepe.jpg" alt='evolution' className='rounded-l-lg h-88' />
                            <Image width={300} height={600} src="/pepe-matt-furie.jpg" alt='evolution' className='rounded-r-lg h-88' />
                        </div>
                        ...
                        <div className='flex justify-center items-center'>
                            <Image width={400} height={600} src="/hoppy-matt-furie.jpg" alt='evolution' className='rounded-l-lg h-80' />
                            <Image width={400} height={600} src="/memetic-hoppy.jpg" alt='evolution' className='rounded-r-lg h-80' />
                        </div>
                    ...
                    <div className="w-[80%] p-5 bg-[#63681e] rounded-2xl gap-8 flex flex-col">
